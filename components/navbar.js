...
function header(){
    return `
    <a href="/-scary-flower/index.html"><img src ="https://www.beautybebo.com/pub/media/ads/ad-desktop.jpg"></a>
        <div>
        ...
        <div class="landr">
          <a href="../favorite/fav.html"><button><i class="fa-solid fa-heart"></i></button></a>
    ...
    <img src ="https://www.beautybebo.com/pub/media/ads/ad-desktop.jpg">
        ...
        <div class="landr">
          ...
          <button><i class="fa-solid fa-user"></i>
              <div class="myaccount">
                <ul>
                 <li><a href="/-scary-flower/login.html">Login</a></li>
                 <hr>
                 <li><a href="/-scary-flower/signin.html">Register</a></li>
                </ul>
              </div>
          </button>
          <span>My Account</span>
          <a href="/-scary-flower/adminLogin.html"><button><i class="fa-solid fa-house"></i></button></a>
...
function navbar(){
    ...
    <div class="nav">
    <ul>
        <li><a href="./Makeup/makeup.html">MAKEUP</a> 
          <div id="sub-m">
        ...
        <li><a href="./Skin/skin.html">SKIN </a>
        <div id="sub-skin">
      ...
      <li><a href="./Hair/hair.html">HAIR</a>
      <div id="sub-hair">
         <div class="sub-hair">
                <div>
                  <h3>Hair Care</h3>
        ...
        <li><a href="./PersonalCare/personalCare.html">PERSONAL</a>
         <div id="sub-personal">
...
" alt="">
        ...
        <li><a href="./mom&babyCare/babyCare.html">MOM & BABY CARE</a>
           <div id="sub-mom">
                 <div class="sub-mom">
             <div>
              <h3>Baby Care</h3>
...
" alt="">
        ...
        <li><a href="/-scary-flower/Ayurveda/ayurveda.html">AYURVEDA</a>
           <div id="sub-ayurveda">
